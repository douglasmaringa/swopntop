...
function Category() {
    ...
    useEffect(() => {
        ...
        db.collection("products").where("category","==",state).onSnapshot(querySnapshot=>{
...
const find =()=>{
  ...
  return (
    <div>
       <Nav/>
       <h5 class="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white hover:text-red-800"><span className="bg-gray-100 px-2 py-1.5 text-white mr-1 rounded-full">	😊</span>{state}</h5>
